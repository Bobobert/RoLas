...
from rofl.functions.functions import clipReward, np, torch, rnd, noGrad, ceil
...
class PgAgent(BaseAgent):
    ...
    def processObs(self, obs, info, done, reset = False):
...
class PgFFAgent(PgAgent):
    ...
    def processObs(self, obs, info, done, reset: bool = False): # TODO: pass this to a function that uses lHistObsProcess
