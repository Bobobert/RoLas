...
def plot_grid(grid, title=CONFIG["plot_title"], **kwargs):
    ...
    default_kwargs = {
        ...
        "color_burnt": CONFIG["cell_colors"]["burnt"]
    }
    ...
    color_burnt = kwargs["color_burnt"]
    colors_forest = color_empty, color_tree, color_fire, color_burnt
...
def add_helicopter(fig, pos):
    ...
    ax.plot(col, row, marker=helicopter, markersize=20, color="1", fillstyle="none")
